...
public class HistComparison {
	...
	public void run()
	{
	        ...
	        Mat srcBase = Imgcodecs.imread("resources/images/Angelina_Jolie_009.jpg");
	        Mat srcTest1 = Imgcodecs.imread("resources/images/Brad_Pitt_009.jpg");
	        Mat srcTest2 = Imgcodecs.imread("resources/images/Halbmond.jpg");
